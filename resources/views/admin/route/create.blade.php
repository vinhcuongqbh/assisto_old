            ...
            <div class="col-xl-6">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title text-bold">{{ __('newRoute') }}</h3>
                    </div>
                    @if ($errors->any())
                    ...
                    @endif
                    <form action="{{ route('route.store') }}" method="post" id="route-create">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="routeId" name="routeId" value="{{ old('routeId') }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" id="routeDate" name="routeDate" value="{{ old('routeDate') }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
